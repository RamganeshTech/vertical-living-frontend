...
export const SIDEBAR_LABELS: Record<string, string> = {
  ...
  CAD: "CAD Analytics",
  TOOLMANAGEMENT: "Tools & Hardware Management",
  HR: "HR Dept",
  LOGISTICS: "Logistics",
  ...
  COSTCALCULATIONLEADFORM: " Cost Calculator Leads",
  INSTAGRAMLEAD: "Instagram Leads",
  WHATSAPPLEAD: "Whatsapp Leads",
  METALEAD: "Meta Leads",
  VERTICALLIVINGCONFIG: "Vertical Living Configuration",
...
export const SIDEBAR_ICONS: Record<string, string> = {
  ...
  CAD: "fas fa-wand-magic-sparkles text-2xl",
  TOOLMANAGEMENT: "fas fa-tools text-2xl",
...
export const PROJECTS_ICONS: Record<string, string> = {
  ...
  DESIGNAPPROVAL: "fa-solid fa-object-group text-2xl",
