...
type EditableFieldKey = StringLikeKeys<MaterialSpecification>;
...
// ended
    ...
    const handleAddToCart = async () => {
        ...
        try {
            ...
            toast({
                title: "Success",
                description: `${form.description || 'Item'} ${selectedVariant ? `(${selectedVariant.color})` : ''} added to cart`
            });
            refetchCart();
        } catch (e: any) {
            toast({
                            ...
                            <CardContent className="p-0">
                                ...
                                <div className="p-6 bg-gradient-to-br from-violet-50 to-blue-50">
                                    <div className="space-y-4">
                                        ...
                                        {/* Add to Cart Button */}
                                        {/* <Button
                                            className="w-full mt-4 bg-gradient-to-r from-violet-600 to-blue-600 hover:from-violet-700 hover:to-blue-700 text-white"
                                            onClick={() => {
                                                // Handle add to cart with selected variant data
                                                const cartData = {
                                                    id: id,
                                                    itemCode: displayValues.itemCode,
                                                    mrp: displayValues.mrp,
                                                ...
                                                toast({
                                                    title: "Added to Cart",
                                                    description: `${form.description} (${displayValues.color || 'default'}) added to cart`,
                                                    variant: "default"
                                                });
                                            }}
                                        >
