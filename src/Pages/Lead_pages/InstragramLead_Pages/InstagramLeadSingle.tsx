...
//         switch (status) {
//             case 'New': return 'bg-action-primary/10 text-action-primary border-action-primary/20';
//             case 'Contacted': return 'bg-action-warning/10 text-action-warning border-action-warning/20';
//             case 'Interested': return 'bg-action-success/10 text-action-success border-action-success/20';
//             case 'Not Interested': return 'bg-action-danger/10 text-action-danger border-action-danger/20';
//             case 'Converted': return 'bg-brand-main text-brand-surface border-brand-main';
...
//     if (isError || !lead) {
//         return (
//             <div className="max-w-2xl mx-auto mt-8 p-6 bg-action-danger/5 border border-action-danger/20 rounded-xl text-center">
...
//                     <button
//                         onClick={() => navigate(-1)}
//                         className="px-6 py-2 bg-brand-surface text-text-main border border-brand-ash rounded-lg hover:bg-brand-surface-hover transition-colors"
//                     >
//                         Go Back
//                     </button>
//                     <button
//                         onClick={() => refetch()}
//                         className="px-6 py-2 bg-action-primary text-brand-surface rounded-lg hover:bg-action-primary-hover transition-colors"
//                     >
//                         Try Again
//                     </button>
//                 </div>
...
//                 <button
//                     onClick={() => navigate(-1)}
//                     className="flex cursor-pointer items-center text-text-muted hover:text-action-primary transition-colors text-sm font-medium"
//                 >
//                     <i className="fas fa-arrow-left mr-2"></i> Back to Leads
//                 </button>
//                 {/* <div className="text-xs text-text-soft flex items-center">
//                     <i className="fas fa-fingerprint mr-2"></i> ID: {lead.senderId}
//                 </div> */}
//             </div>

//             {/* Main Detail Card */}
//             <div className="bg-brand-surface rounded-2xl border border-brand-ash shadow-sm overflow-hidden">

//                 {/* Profile Header Section */}
//                 <div className="p-6 md:p-8 border-b border-brand-ash flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
//                     <div className="flex items-center gap-5">
//                         <div className="w-16 h-16 rounded-full bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] p-0.5 flex-shrink-0">
...
//                                 className="text-action-primary hover:text-action-primary-hover font-medium flex items-center transition-colors"
//                             >
...
//                                 disabled={isUpdating}
//                                 className={`w-full appearance-none px-4 py-2.5 pr-10 rounded-lg border font-medium outline-none cursor-pointer transition-all ${getStatusBadge(lead.status)} ${isUpdating ? 'opacity-50 cursor-not-allowed' : 'hover:shadow-sm'}`}
//                             >
...
//                                 <i className="far fa-comment-dots mr-2"></i> Latest Interaction
//                             </h3>
//                             <div className="bg-brand-surface-hover rounded-xl p-5 border border-brand-ash">
//                                 <p className="text-text-main text-lg leading-relaxed whitespace-pre-wrap">
...
//                         <div>
//                             <h3 className="text-sm font-semibold text-text-muted uppercase tracking-wider mb-3 flex items-center">
//                                 <i className="far fa-clock mr-2"></i> Timeline
//                             </h3>
//                             <div className="bg-brand-surface-hover rounded-xl p-5 border border-brand-ash space-y-4">
//                                 <div>
//                                     <span className="block text-xs text-text-soft mb-1">First Contacted</span>
...
//                                     </div>
//                                 </div>
//                                 <hr className="border-brand-ash" />
//                                 <div>
//                                     <span className="block text-xs text-text-soft mb-1">Last Updated</span>
//                                     <div className="font-medium text-text-strong">
...
//                                     target="_blank"
//                                     rel="noopener noreferrer"
//                                     className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-action-primary text-brand-surface rounded-lg hover:bg-action-primary-hover transition-colors font-medium"
//                                 >
//                                     <i className="fab fa-instagram"></i> Reply on Instagram
//                                 </a>
//                                 {/* <button className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-brand-surface text-action-secondary border border-action-secondary rounded-lg hover:bg-action-secondary-hover hover:text-brand-surface transition-colors font-medium">
