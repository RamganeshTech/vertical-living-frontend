                ...
                <Card className="bg-white/80 backdrop-blur-lg border-0 shadow-2xl">
                    <CardHeader className="text-center pb-6">
                        ...
                        <CardDescription className="text-blue-600 text-base">
                            Complete your registration to join the team as Client
                        </CardDescription>
                    </CardHeader>
                    ...
                    <CardContent className="space-y-6">
                        <form onSubmit={handleSubmit} className="space-y-2">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="clientName" className="text-blue-800 font-medium">
                                    Full Name *
                                </Label>
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className={`pl-10 border-2 transition-all duration-200 ${errors.clientName ? "border-red-300 focus:border-red-500" : "border-blue-200 focus:border-blue-500"
