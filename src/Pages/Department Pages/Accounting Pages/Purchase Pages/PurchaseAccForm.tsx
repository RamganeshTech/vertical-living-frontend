...
export type PurchaseFormData = Pick<
    CreatePurchasePayload,
    | 'vendorId'
    | 'vendorName'
    | 'deliveryAddress'
...
interface PurchaseAccFormProps {
    mode: 'create' | 'view' | 'edit';
    initialData?: PurchaseFormData;
    onSubmit: (data: PayloadPurchase) => Promise<void>;
    isSubmitting: boolean;
    organizationId: string;
}

const PurchaseAccForm: React.FC<PurchaseAccFormProps> = ({
    mode: initialMode,
    initialData,
    onSubmit,
    isSubmitting,
 ...
 const { role, permission } = useAuthCheck();
    ...
    const validateForm = (formData: PurchaseFormData): string[] => {
        const errors: string[] = [];
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const payload: PayloadPurchase = {
            ...dataToValidate,
            organizationId: '', // Will be set in CreatePurchasePayload component
