...
import { useGetVendor, useUpdateVendor, useUpdateVendorDocument, type UpdateVendorPayload } from '../../../../apiList/Department Api/Accounting Api/vendorAccApi';
                    ...
                    {activeTab === 'other' && (
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <p className="text-gray-900">{vendor.accountsReceivable || '-'}</p>
                            </div>
