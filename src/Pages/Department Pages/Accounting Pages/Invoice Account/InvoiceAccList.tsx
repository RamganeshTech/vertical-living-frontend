...
const InvoiceAccList: React.FC<Props> = ({ invoice, index, handleView, handleDelete, deleteInvoiceMutation }) => {
    ...
    return (
        <div
            className="grid cursor-pointer grid-cols-14 gap-4 px-6 py-4 border-b border-ash-light hover:bg-brand-surface-hover transition-colors items-center last:border-b-0"
            onClick={() => handleView(invoice._id!)}
        >
            {/* S.No */}
