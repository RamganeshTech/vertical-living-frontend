...
//                                 <Label htmlFor='enableName' className='cursor-pointer'>Click the check box to enter the name manually</Label>
//                             </div>
//                             <input
//                                 type="text"
//                                 name="customerName"
...
//                 {isReadOnly && initialData.pdfData && <section>
...
//                                             {initialData?.pdfData?.originalName}
//                                         </h4>
//                                         {/* <span className="text-sm">Pdf Reference Id: {initialData.pdfData.originalName || "N/A"}</span> */}
//                                         <p className="text-sm text-green-700">
//                                             Your Invoice PDF is ready to view or download
//                                         </p>
//                                     </div>
//                                 </div>
...
//                                     <Button
//                                         variant="secondary"
//                                         onClick={() => downloadImage({ src: initialData.pdfData.url, alt: "Invoice pdf" })}
