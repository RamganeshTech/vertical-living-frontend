...
const ProcurementCard: React.FC<Props> = ({
  ...
  const canDelete = role === "owner" || permission?.procurement?.delete;
      ...
      <CardContent className="p-0">
        ...
        <div className="p-3 flex justify-between items-start border-b border-gray-50 pb-2">
          ...
          <div className="flex flex-col items-end gap-1.5">
            ...
            {/* {(typeof isSyncWithPaymentsSection === 'boolean') && ( */}
            {(typeof isSyncWithPaymentsSection === "boolean" && isSyncWithPaymentsSection === true) && (
              // Case: True (Sent to Payment)
            ...
            {(typeof isSyncWithPaymentsSection === "boolean" && isSyncWithPaymentsSection === false) && (
              // Case: False (Pending/Pre-Payment)
              <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[9px] font-bold bg-gray-100 text-gray-500 uppercase tracking-wide border border-gray-200">
        ...
        <div className="px-3 py-2 space-y-1.5 grid grid-cols-2">
          ...
          {
            createdAt && <div className="flex items-center gap-2 text-xs text-gray-600">
              <div className="w-4 flex justify-center">
                <i className="fas fa-calendar  text-gray-400 text-[10px]"></i>
              </div>
