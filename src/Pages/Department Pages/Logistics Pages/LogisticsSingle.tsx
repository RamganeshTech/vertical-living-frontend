...
// import { formatDateTimeLocal } from "./LogisticsShipmentForm";
...
//     const { data: shipment, isLoading } = useGetSinglShipment(id);
...
//     return (
//         <div className="p-6 max-w-full max-h-full overflow-y-auto mx-auto space-y-6">
//             <Card>
...
//                             <div>
//                                 <h5 className="font-medium text-blue-600 mb-1">Origin</h5>
...
//                             </div>
//                             <div>
//                                 <h5 className="font-medium text-blue-600 mb-1">Destination</h5>
...
//                                     <div className="grid grid-cols-3 bg-gray-50 p-2 font-medium text-gray-700">
//                                         <p>Item Name</p>
//                                         <p>Quantity</p>
//                                         <p>Weight (kg)</p>
//                                     </div>
...
//                                         <div
//                                             key={index}
//                                             className="grid grid-cols-3 p-2 text-sm text-gray-800"
//                                         >
//                                             <p>{item.name}</p>
//                                             <p>{item.quantity}</p>
//                                             {/* <p>{item.weight || "-"}</p> */}
...
// import { Separator } from "../../../components/ui/Seperator";
// import { type IShipmentItem, type ILogisticsShipment } from "./LogisticsMain";
// import { formatDateTimeLocal } from "./LogisticsShipmentForm";
// import MaterialOverviewLoading from "../../Stage Pages/MaterialSelectionRoom/MaterailSelectionLoadings/MaterialOverviewLoading";
...
//     <h3 className="text-xl font-semibold text-blue-900 border-b pb-1">{title}</h3>
//     {children}
//   </section>
// );
...
//   return (
//     <div className="p-2 max-h-full overflow-y-auto max-w-full mx-auto">
//       {/* Heading */}
//       <div className="mb-6">
//         <h1 className="text-3xl font-bold text-gray-900">
//           Shipment: {shipment?.shipmentNumber || "N/A"}
//         </h1>
//         <p className="text-sm text-gray-500">Status: <span className="capitalize">{shipment?.status}</span></p>
//       </div>
...
//               <div>
//                 <h4 className="text-blue-700 font-semibold mb-2">Origin</h4>
//                 <InfoRow label="Address" value={shipment?.origin?.address} />
//                 <InfoRow label="Contact Person" value={shipment?.origin?.contactPerson} />
//                 <InfoRow label="Contact Phone" value={shipment?.origin?.contactPhone} />
//               </div>
//               <div>
//                 <h4 className="text-blue-700 font-semibold mb-2">Destination</h4>
//                 <InfoRow label="Address" value={shipment?.destination?.address} />
//                 <InfoRow label="Contact Person" value={shipment?.destination?.contactPerson} />
//                 <InfoRow label="Contact Phone" value={shipment?.destination?.contactPhone} />
//               </div>
