...
import { useGetPublicSubContWorkDetails, useSubmitWorkerInfo, useUploadAfterWorkFiles } from "../../apiList/SubContract Api/subContractApi";
...
const PublicSubContract = () => {
  ...
  const { data: submission, isLoading } = useGetPublicSubContWorkDetails({ subContractId: subContractId!, submissionToken: submissionToken || "" });
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <Button
                    ...
                    className="w-full bg-blue-600 hover:bg-blue-700"
                    disabled={uploadAfterMutation.isPending || !submissionToken}
                  >
