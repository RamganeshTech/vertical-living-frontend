...
import { useDeleteMicaReferenceDesign, useGetMicaReferenceDesigns, useUploadMicaReferenceDesigns } from "../../../../apiList/Stage Api/shortlistMicaReferenceApi";


const allowedImageTypes = ["image/jpeg", "image/jpg", "image/png", "image/webp"];

export default function ShortListMicaReferenceDesignMain() {
    //   const [selectedFiles, setSelectedFiles] = useState<File[]>([]);
    const { organizationId } = useParams() as { organizationId: string }

    const { data: imageData, refetch, isFetching } = useGetMicaReferenceDesigns({
        organizationId,
    });

    const { mutateAsync: uploadImages, isPending:uploadPending } = useUploadMicaReferenceDesigns();
    const { mutateAsync: deleteImage, } = useDeleteMicaReferenceDesign();
