...
//       toast({ 
//         title: "Error", 
//         description: error?.response?.data?.message || error.message || "Failed to create room status", 
//         variant: "destructive" 
//       });
//     }
//   };
...
//       toast({ 
//         title: "Error", 
//         description: error?.response?.data?.message || error.message || "Failed to delete the room", 
//         variant: "destructive" 
//       });
//     }
//   };
...
//       toast({ 
//         title: "Error", 
//         description: error?.response?.data?.message || error.message || "Failed to delete the files", 
//         variant: "destructive" 
//       });
//     }
//   };
...
//   return (
//     <div className="container mx-auto px-2 sm:px-4 lg:px-6 py-4 max-w-full overflow-y-hidden min-h-screen">
//       {/* Responsive Header */}
//       <div className="flex border flex-col sm:flex-row justify-between items-start lg:items-center gap-4 mb-6">
//         <h2 className="text-2xl sm:text-3xl font-semibold text-blue-600 flex items-center">
//           <i className="fa-solid fa-object-group mr-2"></i>Sample Design Files
//         </h2>
        
//         <div className=" border  !w-[90%] sm:!w-[50%] justify-end lg:justify-end flex flex-col sm:flex-row gap-3">
...
//               {sampleDesign.rooms.map((room: any) => (
//                 <div key={room.roomName} className="bg-white border-l-4 border-blue-600 rounded-xl shadow-sm p-4 sm:p-6 flex flex-col">
...
//                       variant="danger" 
//                       className="bg-red-600 text-white w-full sm:w-auto mt-2 sm:mt-0"
//                     >
//                       <i className="fa-solid fa-trash mr-2"></i>
//                       Delete
//                     </Button>
...
const SampleDesignModule: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-2 lg:px-1 py-4 max-w-full min-h-full">
      {/* Responsive Header */}
