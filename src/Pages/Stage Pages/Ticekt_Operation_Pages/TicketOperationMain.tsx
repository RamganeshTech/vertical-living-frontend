...
} from "../../../apiList/Stage Api/ticketOperationApi"
...
const TicketOperation: React.FC<Props> = ({ showHeader = true, showFilters = true }) => {
    ...
    return (
        <main className="h-full w-full !max-w-full !overflow-y-auto bg-gradient-to-br from-blue-50 to-white p-2">
            ...
            <main className="flex flex-col w-full h-full lg:max-h-[92%] lg:flex-row gap-4 overflow-y-auto">

                {/* filters */}
                {showFilters && <aside className="w-full lg:w-3/12 flex flex-col border-r border-blue-200">

                    <div className="flex-shrink-0 !max-h-[100%] overflow-y-auto">
                        <div className="bg-white rounded-xl shadow-sm md:p-4 lg:p-6 border border-gray-100">
                            ...
                            <div className="space-y-6">
                                {/* Search */}
                                <section className="flex gap-4 lg:flex-col justify-between !items-start md:!items-end">
                                    {/* <section className="flex gap-2 lg:flex-col justify-between"> */}
                                        ...
                                        <div className="w-full md:max-w-50 lg:max-w-full">
                                            <label className="block text-sm font-medium text-gray-700 mb-2">
                                                Select Project
                                            </label>
                ...
                <section className="flex !w-full flex-col md:flex-row flex-1 gap-4 min-h-[200px] lg:min-h-0">

                    {/* Middle Sidebar - Discussions List (70% width) */}
                    {/* <div className="w-full lg:w-1/2 flex flex-col border-r border-blue-200"> */}
                    {/* <div className="w-full md:w-1/2 lg:w-[40%] flex flex-col border-b md:border-b-0 md:border-r border-blue-200 pb-4 md:pb-0 shrink-0"> */}
                    <div className="w-full md:!w-1/2 lg:w-[40%] flex flex-col border-b md:border-b-0 md:border-r border-blue-200 pb-4 md:pb-0">
                        {/* Discussions List */}
                    ...
                    <div className="w-full md:flex-1 flex flex-col bg-white rounded-lg border border-blue-200 overflow-y-auto">
...
export const TicketOperationPage = TicketOperation;


const TicketOperationMain = () => {
    return (
...
export default TicketOperationMain