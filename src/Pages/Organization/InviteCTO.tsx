...
//       try {
//         await removeCTO.mutateAsync({
//           CTOId,
//           orgId: organizationId!,
//         })
//         toast({
//           title: "Success",
//           description: `${CTOName} has been removed from the organization`,
//         })
//       } catch (error: any) {
//         toast({
//           title: "Error",
//           description: error.message || "Failed to remove CTO member",
//           variant: "destructive",
//         })
//       }
//     }
...
//     try {
//       const response = await inviteCTO.mutateAsync({
...
//             Invite Chief Technical Officers
//           </CardTitle>
//         </CardHeader>
...
//               {inviteCTO.isPending ? "Generating..." : "Generate Invitation Link"}
//             </Button>
//           ) : (
...
//                   {inviteCTO.isPending ? "Generating..." : "Generate Another"}
//                 </Button>
//               </div>
//             </div>
//           )}
...
//                 <span className="text-lg">CTO Members ({CTOs?.length || 0})</span>
//               </div>
//             </CardTitle>
//           </CardHeader>
//           <CardContent>
...
//                         <AvatarImage src={ctoMember?.avatarUrl || COMPANY_DETAILS.COMPANY_LOGO} />
//                         <AvatarFallback className="bg-gradient-to-br from-blue-500 to-blue-600 text-white font-semibold">
//                           {getInitials(ctoMember?.CTOName)}
//                         </AvatarFallback>
//                       </Avatar>
//                       <div className="min-w-0 flex-1">
//                         <h4 className="font-semibold text-blue-900 truncate">{ctoMember?.CTOName}</h4>
//                         <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 text-sm text-gray-600 gap-1 sm:gap-0">
//                           <div className="flex items-center space-x-1">
//                             <i className="fas fa-envelope text-xs"></i>
//                             <span className="truncate">{ctoMember.email}</span>
//                           </div>
//                           {ctoMember.phoneNo && (
//                             <div className="flex items-center space-x-1">
//                               <i className="fas fa-phone text-xs"></i>
//                               <span>{ctoMember?.phoneNo}</span>
//                             </div>
//                           )}
//                         </div>
...
//                     </div>
//                     <Button
//                       onClick={() => handleRemoveCTO(ctoMember?._id, ctoMember?.CTOName)}
//                       variant="danger"
//                       size="sm"
...
//                 </div>
//                 <h3 className="text-lg font-semibold text-blue-900 mb-2">No CTO Members Yet</h3>
//                 <p className="text-blue-600 mb-4 text-sm sm:text-base">
//                   Invite CTO members to start building your team
//                 </p>
//                 <Button
//                   onClick={handleGenerateInviteLink}
//                   variant="primary"
