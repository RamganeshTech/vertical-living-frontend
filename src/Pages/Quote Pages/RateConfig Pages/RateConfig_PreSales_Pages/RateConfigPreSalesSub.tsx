...
export default function RateConfigPreSalesSub() {
    ...
    return (
        <div className="space-y-4 max-h-full overflow-y-auto overflow-x-hidden max-w-[100%] ">
       
            {/* Sticky Header */}
            <header className="flex flex-col sm:flex-row sm:justify-between sm:items-center sticky top-0 bg-white z-10 py-4 border-b">
            ...
            <div className="overflow-x-auto min-h-[450px] flex-1 min-w-0 w-full">
            
                <table className=" w-full bg-white text-sm table-auto border-collapse">
                    {/* Table Head */}
                    <thead
