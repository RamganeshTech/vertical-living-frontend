...
import { useGetMaterialWithLabourRateConfigCategories, useUpdateMaterialAndLabourCategoryDescription } from "../../../../apiList/Quote Api/RateConfig Api/rateConfigLabourwithMaterialApi";
import { toast } from "../../../../utils/toast";
import MaterialOverviewLoading from "../../../Stage Pages/MaterialSelectionRoom/MaterailSelectionLoadings/MaterialOverviewLoading";
import { Button } from "../../../../components/ui/Button";
import { Textarea } from "../../../../components/ui/TextArea";

export default function MaterialAndLabourConfigDescription() {
    const { organizationId, id: categoryId } = useParams();
    const navigate = useNavigate();

    // API Hooks
    const { data: categories, isLoading } = useGetMaterialWithLabourRateConfigCategories(organizationId!);
    const { mutateAsync: updateScope } = useUpdateMaterialAndLabourCategoryDescription();
