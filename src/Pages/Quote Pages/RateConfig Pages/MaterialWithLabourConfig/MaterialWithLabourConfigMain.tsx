...
import { useCreateMaterialWithLabourRateConfigCategory, useDeleteMaterialWithLabourRateConfigCategory, useGetMaterialWithLabourRateConfigCategories } from "../../../../apiList/Quote Api/RateConfig Api/materialLabourRateConfigApi";
...
export default function MaterialWithLabourRateMain() {
    ...
    const { data: categories, isLoading, refetch } = useGetMaterialWithLabourRateConfigCategories(organizationId!);
    const { mutateAsync: createCategory, isPending: createPending } = useCreateMaterialWithLabourRateConfigCategory();
    const { mutateAsync: deleteCategory, isPending } = useDeleteMaterialWithLabourRateConfigCategory();
        ...
        <div className="space-y-6 max-h-full overflow-y-auto ">
            ...
            <header className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 ">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 flex items-center">
                        ...
                        Material with Labour Rate Configuration
                    </h1>
                    <p className="text-gray-600 mt-1">
                        Manage both labour and material charges here
                    </p>
                </div>
                        ...
                        <div className="space-y-2">
                            {fields.map((field, index) => (
                                <div key={index} className="flex gap-2 items-center">
                                    <Input
                                        placeholder="Field key (e.g: Material or Labour name, Rs, notes)"
                                        value={field.key}
                                        onChange={(e) => {
                                            if (field.key !== "Rs") {
            ...
            {!isLoading && categories?.length === 0 && (
                <div className="flex flex-col items-center justify-center min-h-[300px] w-full bg-white rounded-xl   text-center p-6">
                    ...
                    <h3 className="text-lg font-semibold text-blue-800 mb-1">No Category Configuration Found</h3>
                    <p className="text-sm text-gray-500">
                        Looks like there are no Labour and Material Rate Configuration yet for this organization.<br />
