...
import { useGetAllClientQuotesv1 } from "../../../apiList/Quote Api/ClientQuote/clientQuoteApi";
...
const ClientQuoteMain = () => {
    ...
    // const { data: quotes, isLoading } = useGetAllClientQuotes(organizationId!, apiFilters);
    const { data: quotes, isLoading } = useGetAllClientQuotesv1(organizationId!, apiFilters);
        ...
        <div className="p-2 max-h-full overflow-y-auto  min-h-full">
            <header className="flex justify-between items-center">
                <div className="flex gap-2">
                    ...
                    <h1 className="text-2xl font-bold mb-4">Quotes for Clients</h1>
                </div>
                ...
                {/* <div className="flex gap-2">
                    ...
                    <input
                        type="text"
                        placeholder="Search by Quote No (eg:42, 34)"
                        value={searchInput}
                        autoFocus
...
{/* kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkaaaaaaaaaaaaaaaaaaaaa kkkkkkkkkkkkkkkkkkk */}
            ...
            <main className="flex gap-4 w-full h-[calc(100vh-99px)] overflow-hidden">
                    ...
                    {isLoading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-20 text-center text-gray-700">
                            ...
                            <p className="text-base text-gray-500 leading-relaxed max-w-md">
                                You haven't generated any quote for clients yet.
                                <br />
                                Please create a quote from the
                                <span className="font-semibold text-blue-600 cursor-pointer" onClick={internalQuoteNavigate}> Quote Varient </span>
                                section to view for clients.
                            </p>
                        </div>
                    ) : (
...
export default ClientQuoteMain;