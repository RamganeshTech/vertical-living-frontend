    ...
    return (
        ...
        ${filters?.overdue
                            ...
                            <div>
                                ...
                                <Select
                                    value={filters.status === "in_progress" ? "In progress" : filters.status}
                                    onValueChange={(val) =>
                                        setFilters(prev => ({ ...prev, status: val }))
                                    }
                                >
                                    <SelectTrigger className="bg-white w-full">
                                        <SelectValue placeholder="Select status" selectedValue={filters.status === "in_progress" ? "In progress" : filters.status} />
                                    </SelectTrigger>
                                    <SelectContent>
...
export default SingleStaffList