...
export default function AssignStageStaff({
  ...
  const staffList = realStaffList?.length ? realStaffList : dummyStaffList;
  ...
  return (
    <div className="relative inline-flex items-center px-2 py-1 rounded-lg text-sm ">
      ...
      {/* Dropdown */}
      {isEditing && (
        <div className="absolute z-10 top-full left-[-30%] mt-2 w-[200px] bg-white border border-blue-200 rounded-md shadow-lg max-h-48 overflow-auto text-sm">
          {isLoading ? (
