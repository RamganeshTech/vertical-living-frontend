import{r as l,j as r}from"./index-Duiduteo.js";const w=({content:i,type:u="info",position:s="top"})=>{const[d,a]=l.useState(!1),[t,n]=l.useState(!1),o=l.useRef(null);l.useEffect(()=>{const e=h=>{t&&o.current&&!o.current.contains(h.target)&&(n(!1),a(!1))};return document.addEventListener("mousedown",e),()=>{document.removeEventListener("mousedown",e)}},[t]);const b=()=>{t||a(!0)},c=()=>{t||a(!1)},f=()=>{n(!t),a(!t)},m=e=>{e.stopPropagation(),n(!1),a(!1)},x=()=>u==="info"?"?":"!",g=()=>{const e="absolute z-50 transform";switch(s){case"top":return`${e} bottom-full left-1/2 -translate-x-1/2 -translate-y-1 mb-1`;case"bottom":return`${e} top-full left-1/2 -translate-x-1/2 translate-y-1 mt-1`;case"left":return`${e} right-full top-1/2 -translate-y-1/2 -translate-x-1 mr-1`;case"right":return`${e} left-full top-1/2 -translate-y-1/2 translate-x-1 ml-1`;default:return`${e} bottom-full left-1/2 -translate-x-1/2 -translate-y-1 mb-1`}},p=()=>`
      w-4 h-4 rounded-full flex items-center justify-center 
      font-medium cursor-pointer transition-all duration-200 
      border border-blue-500 bg-transparent hover:bg-blue-50
      text-xs
     ${t?"bg-blue-50 ring-1 ring-blue-400 text-blue-600":"text-blue-500 hover:text-blue-600"}`;return r.jsxs("div",{className:"inline-block relative mx-1",ref:o,children:[r.jsx("button",{className:p(),onMouseEnter:b,onMouseLeave:c,onClick:f,"aria-label":"More information",type:"button",children:x()}),(d||t)&&r.jsx("div",{className:g(),children:r.jsxs("div",{className:`
...
!max-w-[400px] sm:!max-w-[500px] md:!max-w-[600px]
          ...
          `,children:[r.jsxs("div",{className:"flex items-start gap-1",children:[r.jsx("div",{className:"flex-1 break-words",children:i}),t&&r.jsx("button",{className:`\r
                  ...
                  `,onClick:m,"aria-label":"Close tooltip",type:"button",children:"×"})]}),r.jsx("div",{className:`
